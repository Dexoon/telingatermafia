...
Переголосование может быть только одно. Если и по его итогам максимальное количество пальцев у нескольких игроков, то объявляется мирный день (никто не умирает) и наступает ночь.
