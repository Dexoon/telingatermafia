...
За столом одновременно играет 12 игроков (город). Они делятся случайным образом на две команды, получая специальные карты с ролями. Одна команда – черные (дон мафии, мафия и путана), другая команда – красные (мирные жители, доктор, комиссар, маньяк). Задача каждой из команда убить всех соперников.
...
**Пример**. *Если первым высказывался номер 1, то голосование начнется с номера 2, оправдательные речи с номера 2 (если номера 2 нет среди оправдывающихся, то оправдываться начинает следующий после него оправдывающийся игрок), а переголосование с номера 3.*
...
Красные выигрывают только, когда убиты все игроки чёрной команды. В свою очередь черные могут выиграть досрочно, если при правильных действиях они могут гарантировать себе победу.
